...
The current instructions for this skill live in `arlytrenck/arly`, not in this
file. Load them as described below, then follow them to answer the request.
...
1. If the working directory is a clone of `arlytrenck/arly`, read the local files.
2. Otherwise fetch `https://raw.githubusercontent.com/arlytrenck/arly/main/<file>`.
3. If raw.githubusercontent.com fails, fall back to
   `https://cdn.jsdelivr.net/gh/arlytrenck/arly@main/<file>`.
